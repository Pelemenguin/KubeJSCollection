...
/** @type {typeof EnumJS} */
let exported = {
    createEnum(className, components) {
        className += ""; // Make sure this is a JS string, not a Java String,
        ...
        components.forEach((c, index) => clinitField(clinit, className, c, index));
